 ...
 * Generated at: 2022-11-28 13:06:53 UTC
...
public final class login_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/basicauth.jsp", Long.valueOf(1669456822922L));
    _jspx_dependants.put("/includes/init-url.jsp", Long.valueOf(1669456826666L));
    _jspx_dependants.put("/openid.jsp", Long.valueOf(1669456823235L));
    _jspx_dependants.put("/includes/init-loginform-action-url.jsp", Long.valueOf(1669456826541L));
    _jspx_dependants.put("/includes/localize.jsp", Long.valueOf(1669456827178L));
    _jspx_dependants.put("/identifierauth.jsp", Long.valueOf(1669456821061L));
    _jspx_dependants.put("/tenantauth.jsp", Long.valueOf(1669456821764L));
  }
 ...
 if (isSelfSignUpEPAvailable && !isIdentifierFirstLogin(inputType)) { 
    ...
    if (proxyContextPath == null) {
      ...
      out.write("\n");
      out.write("                        if (tenantName && tenantName !== \"null\") {\n");
      out.write("\n");
      out.write("                            if (isEmailUsernameEnabled) {\n");
      out.write("\n");
      out.write("                                if (usernameUserInputValue.split(\"@\").length <= 1) {\n");
      ...
      out.write("                                }\n");
      out.write("\n");
      out.write("                                if (usernameUserInputValue.split(\"@\").length === 2) {\n");
      ...
      out.write("                        $.ajax({\n");
      out.write("                            type: \"GET\",\n");
      out.write("                            url: contextPath + \"/logincontext?sessionDataKey=\" + getParameterByName(\"sessionDataKey\") +\n");
 ...
 if (isRecoveryEPAvailable) { 
      ...
      out.write("                href=\"");
      out.print(StringEscapeUtils.escapeHtml4(getRecoverAccountUrl(identityMgtEndpointContext, urlEncodedURL, false, urlParameters)));
      out.write("\"\n");
 ...
 if (isIdentifierFirstLogin(inputType)) { 
    ...
    if (showPrivacyPolicy) {
      ...
      out.write("                type=\"button\"\n");
      out.write("                onclick=\"window.location.href='");
      out.print(StringEscapeUtils.escapeHtml4(getRegistrationUrl(identityMgtEndpointContext, urlEncodedURL, urlParameters)));
      out.write("';\"\n");
      out.write("                class=\"ui large button link-button\"\n");
      out.write("                id=\"registerLink\"\n");
...
if (idpAuthenticatorMapping != null &&
 ...
 if (isHubIdp) { 
      ...
      out.write("                                    <img src=\"libs/themes/default/assets/images/icons/fido-logo.png\" height=\"13px\" /> Key\n");
      out.write("                                </button>\n");
      out.write("                            </div>\n");
      out.write("                            ");
